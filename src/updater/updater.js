/*
    This file is part of TOS Linux Updates Indicator

    TOS Linux Updates Indicator is free software: you can redistribute it and/or modify
    it under the terms of the GNU General Public License as published by
    the Free Software Foundation, either version 3 of the License, or
    (at your option) any later version.

    TOS Linux Updates Indicator is distributed in the hope that it will be useful,
    but WITHOUT ANY WARRANTY; without even the implied warranty of
    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
    GNU General Public License for more details.

    You should have received a copy of the GNU General Public License
    along with TOS Linux Updates Indicator.  If not, see <http://www.gnu.org/licenses/>.
...
const Gettext = imports.gettext.domain('tos');
...
let CHECK_CMD = "/usr/bin/checkupdates-tos";
let MANAGER_CMD = "";
...
var TOSUpdateIndicator = GObject.registerClass(
    {
        _TimeoutId: null,
    ...
    class TOSUpdateIndicator extends PanelMenu.Button {

        _init() {
            super._init(0);
            this.updateIcon = new St.Icon({ gicon: this._getCustIcon('tos-unknown-symbolic'), style_class: 'system-status-icon' });
            ...
            this.menuExpander.menu.box.style_class = 'tos-updates-list';
            ...
            let cancelButton = new St.Button({
                ...
                style_class: 'system-menu-action tos-updates-menubutton',
                x_expand: true
            });
            ...
            // Load settings
            this._settings = ExtensionUtils.getSettings('org.gnome.shell.extensions.tos');
        ...
        _getCustIcon(icon_name) {
            ...
            if (!USE_BUILDIN_ICONS && St.Settings.get().gtk_icon_theme) {
                ...
                if (theme.set_custom_theme) {
                    theme.set_custom_theme(St.Settings.get().gtk_icon_theme); /* Pre Gnome 44 */
                } else {
        ...
        _showChecking(isChecking) {
            if (isChecking == true) {
                this.updateIcon.set_gicon(this._getCustIcon('tos-unknown-symbolic'));
                this.updateIcon.style_class = "system-status-icon";
        ...
        _updateStatus(updatesCount) {
            ...
            if (updatesCount > 0) {
                // Updates pending
                this.updateIcon.set_gicon(this._getCustIcon('tos-updates-symbolic'));
                this.updateIcon.style_class = "yellow system-status-icon";
                    ...
                    if (HOWMUCH > 0) {
                        ...
                        if (updateList.length > 0) {
                            ...
                            this._showNotification(
                                Gettext.ngettext("New TOS Linux Update", "New TOS Linux Updates", updateList.length),
                                updateList.join(', ')
                            );
                        }
                    } else {
                        this._showNotification(
                            Gettext.ngettext("New TOS Linux Update", "New TOS Linux Updates", updatesCount),
                ...
                if (updatesCount == -1) {
                    ...
                    // Error
                    this.updateIcon.set_gicon(this._getCustIcon('tos-error-symbolic'));
                    this.updateIcon.style_class = "red system-status-icon";
                    if (this.lastUnknowErrorString.indexOf("/usr/bin/checkupdates-tos") > 0) {
                        // We do a special change here due to checkupdates moved to pacman-contrib
                        this._updateMenuExpander(false, _("Note : you have to install tos-tools to use the 'checkupdates-tos' script."));
                    } else {
                    ...
                    // Up to date
                    this.updateIcon.style_class = "system-status-icon";
                    this.updateIcon.set_gicon(this._getCustIcon('tos-uptodate-symbolic'));
        ...
        _showNotification(title, message) {
            if (this._notifSource == null) {
                ...
                this._notifSource.createIcon = function() {
                    let gicon = Gio.icon_new_for_string(Me.dir.get_child('icons').get_path() + "/tos-lit-symbolic.svg");
